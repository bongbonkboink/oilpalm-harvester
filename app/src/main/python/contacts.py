...
Storage: JSON file at /data/data/com.example.oilpalmharvester/files/contacts.json
...
_CONTACTS_PATH = "/data/data/com.example.oilpalmharvester/files/contacts.json"
